...
$bestLabel.ForeColor = [System.Drawing.Color]::Black
...
function Show-IntroWindow {
    ...
    $introForm.BackColor = [System.Drawing.Color]::White

    $introLabel = New-Object System.Windows.Forms.Label
    $introLabel.Text = "Get ready to click!"
    $introLabel.ForeColor = [System.Drawing.Color]::Black
...
function Show-HelperWindow {
    ...
    $helperForm.BackColor = [System.Drawing.Color]::White

    $helperLabel = New-Object System.Windows.Forms.Label
    $helperLabel.Text = "Helped by: chatgpt.com"
    $helperLabel.ForeColor = [System.Drawing.Color]::Black
